...
<head>
    <meta charset="UTF-8">
    <title>Trader Dashboard - smart room rent platform</title>
    <style>
        /* General Reset */
        * {
            margin: 0;
...
<body>
    <div class="sidebar">
        <ul class="nav">
            ...
            <li><a href="my_crops.php">🌾 View Available room</a></li>
    ...
    <div class="main-content">
        ...
        <div class="cards">
            <div class="card">
                ...
                <p>See all room uploded by lanloard.</p>
                <a href="my_crops.php" class="btn">View </a>
            </div>
            <div class="card">
                <h3>📩 Send Requests</h3>
                <p>Request to booking room from landloard.</p>
